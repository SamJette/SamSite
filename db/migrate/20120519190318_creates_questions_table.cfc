...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="creates questions table">
  <cffunction name="up">
    <cfscript>
      t = createTable(name='questions');
      t.text(columnNames='question', null=false);
      t.boolean(columnNames='isopen', default='false', null=false);
      t.references(referenceNames="teacher");
      t.timestamps();
      t.create();
    </cfscript>
  </cffunction>
