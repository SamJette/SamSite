...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="add isactivated column to teachers table">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='teachers', columnType='boolean', columnName='isactivated', default=0, null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='teachers',columnName='isactivated');
    </cfscript>
  </cffunction>
</cfcomponent>
