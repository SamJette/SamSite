...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="creates teachers table">
  <cffunction name="up">
    <cfscript>
      t = createTable(name='teachers');
      t.string(columnNames='firstname,name,password,email', null=false);
      t.references(referenceNames="role");
      t.timestamps();
      t.create();
    </cfscript>
  </cffunction>
