...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="add isonline column to students table">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='students', columnType='boolean', columnName='isonline', default=0, null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='students',columnName='isonline');
    </cfscript>
  </cffunction>
</cfcomponent>
