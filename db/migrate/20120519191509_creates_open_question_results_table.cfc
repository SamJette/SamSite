...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="creates open question results table">
  <cffunction name="up">
    <cfscript>
      t = createTable(name='openquestionsresults');
      t.string(columnNames='studentanswer');
      t.references(referenceNames="result");
      t.timestamps();
      t.create();
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
      dropTable('openquestionsresults');
    </cfscript>
  </cffunction>
</cfcomponent>
